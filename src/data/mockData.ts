...
export const mockLeads: Lead[] = [
  ...
  { id: 'l4', name: 'Divya Nair', phone: '+91 65432 10987', source: 'facebook', status: 'property_suggested', assignedAgent: 'Priya Sharma', createdAt: '2026-03-06T11:00:00', lastActivity: '2026-03-08T09:30:00', firstResponseTime: 4, budget: '₹12,000-18,000', preferredLocation: 'Indiranagar', property: 'PG Shaala Residency - Indiranagar' },
  { id: 'l5', name: 'Rohit Kumar', phone: '+91 54321 09876', source: 'phone', status: 'visit_scheduled', assignedAgent: 'Vikram Singh', createdAt: '2026-03-05T16:00:00', lastActivity: '2026-03-08T11:00:00', firstResponseTime: 1, budget: '₹9,000-13,000', preferredLocation: 'Marathahalli', visitDate: '2026-03-10T14:00:00', property: 'PG Shaala Heights - Marathahalli' },
  { id: 'l6', name: 'Meera Joshi', phone: '+91 43210 98765', source: 'landing_page', status: 'visit_completed', assignedAgent: 'Anita Desai', createdAt: '2026-03-03T10:00:00', lastActivity: '2026-03-07T16:00:00', firstResponseTime: 2, budget: '₹11,000-16,000', preferredLocation: 'Whitefield', visitOutcome: 'considering', property: 'PG Shaala Villa - Whitefield' },
  { id: 'l7', name: 'Arjun Kapoor', phone: '+91 32109 87654', source: 'whatsapp', status: 'booked', assignedAgent: 'Rahul Verma', createdAt: '2026-02-28T09:00:00', lastActivity: '2026-03-06T14:00:00', firstResponseTime: 3, budget: '₹10,000-14,000', preferredLocation: 'Electronic City', property: 'PG Shaala Nest - Electronic City' },
  ...
  { id: 'l13', name: 'Suresh Iyer', phone: '+91 65412 34567', source: 'website', status: 'visit_scheduled', assignedAgent: 'Anita Desai', createdAt: '2026-03-06T15:00:00', lastActivity: '2026-03-08T09:00:00', firstResponseTime: 2, budget: '₹10,000-15,000', preferredLocation: 'Whitefield', visitDate: '2026-03-09T11:00:00', property: 'PG Shaala Villa - Whitefield' },
  { id: 'l14', name: 'Kavita Rao', phone: '+91 54312 34567', source: 'facebook', status: 'property_suggested', assignedAgent: 'Priya Sharma', createdAt: '2026-03-05T12:00:00', lastActivity: '2026-03-07T18:00:00', firstResponseTime: 3, budget: '₹8,000-11,000', preferredLocation: 'BTM Layout', property: 'PG Shaala Homes - BTM' },
];

export const mockVisits: Visit[] = [
  { id: 'v1', leadId: 'l5', leadName: 'Rohit Kumar', property: 'PG Shaala Heights - Marathahalli', dateTime: '2026-03-10T14:00:00', assignedStaff: 'Vikram Singh', confirmed: true },
  { id: 'v2', leadId: 'l13', leadName: 'Suresh Iyer', property: 'PG Shaala Villa - Whitefield', dateTime: '2026-03-09T11:00:00', assignedStaff: 'Anita Desai', confirmed: true },
  { id: 'v3', leadId: 'l6', leadName: 'Meera Joshi', property: 'PG Shaala Villa - Whitefield', dateTime: '2026-03-07T15:00:00', assignedStaff: 'Anita Desai', confirmed: true, outcome: 'considering' },
  { id: 'v4', leadId: 'l4', leadName: 'Divya Nair', property: 'PG Shaala Residency - Indiranagar', dateTime: '2026-03-11T10:00:00', assignedStaff: 'Priya Sharma', confirmed: false },
];
